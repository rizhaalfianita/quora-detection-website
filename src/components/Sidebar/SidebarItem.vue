...
<template>
  <li>
    <router-link
      :to="item.route"
      class="group relative flex items-center gap-3.5 rounded-full py-2 px-5 font-medium text-black duration-300 ease-in-out hover:bg-whiten dark:hover:bg-meta-4"
      @click.prevent="handleItemClick"
      :class="{
        'bg-whiten dark:bg-meta-4': sidebarStore.page === item.label
      }"
    >
